...
```json
{
  ...
  "owner" : "cna-team",
  "bsGitRepository" : "github.com?owner=vrabbi&repo=test-acc-v3"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->test-acc-v3]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=vrabbi&repo=test-acc-v3'
